...
<div class="wrap adam-comunidade-admin">
	<h1><?php esc_html_e( 'Community Calendar', 'adam-comunidade' ); ?></h1>
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="adam-card">
		...
		<table class="form-table">
			<tr><th><label for="adam-calendar-title"><?php esc_html_e( 'Title', 'adam-comunidade' ); ?></label></th><td><input class="regular-text" id="adam-calendar-title" name="title" required></td></tr>
			<tr><th><label for="adam-calendar-type"><?php esc_html_e( 'Type', 'adam-comunidade' ); ?></label></th><td><select id="adam-calendar-type" name="entry_type"><?php foreach ( $types as $key => $label ) : ?><option value="<?php echo esc_attr( $key ); ?>"><?php echo esc_html( $label ); ?></option><?php endforeach; ?></select></td></tr>
			...
			<tr><th><label for="adam-calendar-summary"><?php esc_html_e( 'Summary', 'adam-comunidade' ); ?></label></th><td><textarea class="large-text" id="adam-calendar-summary" name="summary"></textarea></td></tr>
		</table>
		<?php submit_button( __( 'Publish calendar entry', 'adam-comunidade' ) ); ?>
	</form>
	<table class="widefat striped">
		<thead><tr><th><?php esc_html_e( 'Title', 'adam-comunidade' ); ?></th><th><?php esc_html_e( 'Type', 'adam-comunidade' ); ?></th><th><?php esc_html_e( 'Starts', 'adam-comunidade' ); ?></th></tr></thead>
		<tbody>
