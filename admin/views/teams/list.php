...
<div class="wrap adam-comunidade-admin adam-teams-admin">
	...
	<nav class="adam-status-nav" aria-label="<?php esc_attr_e( 'Filter teams by status', 'adam-comunidade' ); ?>">
	...
	<form method="get">
		...
		<div class="adam-table-toolbar">
			<label class="screen-reader-text" for="adam-team-district-filter">
				<?php esc_html_e( 'Filter by district', 'adam-comunidade' ); ?>
			</label>
			...
			<label class="screen-reader-text" for="adam-team-municipality-filter">
				<?php esc_html_e( 'Filter by municipality', 'adam-comunidade' ); ?>
			</label>
		...
		<?php
		$table->search_box( __( 'Search Teams', 'adam-comunidade' ), 'adam-team-search' );
		$table->display();
		?>
	</form>
</div>
