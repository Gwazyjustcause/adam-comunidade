	...
	public static function defaults(): array {
		return array(
			self::CHANGES_KEY => array(
				...
				self::reason( 'changes_required_information', __( 'Informação', 'adam-comunidade' ), __( 'Existem informações incompletas.', 'adam-comunidade' ) ),
				self::reason( 'changes_description_incomplete', __( 'Informação', 'adam-comunidade' ), __( 'A descrição necessita de mais detalhes.', 'adam-comunidade' ) ),
				self::reason( 'changes_data_correction', __( 'Informação', 'adam-comunidade' ), __( 'Alguns dados precisam de ser corrigidos.', 'adam-comunidade' ) ),
				...
				self::reason( 'changes_cover_inadequate', __( 'Imagens', 'adam-comunidade' ), __( 'A imagem de capa não é adequada.', 'adam-comunidade' ) ),
				...
				self::reason( 'changes_unverified_information', __( 'Conteúdo', 'adam-comunidade' ), __( 'A informação não pôde ser verificada.', 'adam-comunidade' ) ),
				self::reason( 'changes_guidelines', __( 'Conteúdo', 'adam-comunidade' ), __( 'As alterações não cumprem as diretrizes da ADAM.', 'adam-comunidade' ) ),
