		...
		<div class="<?php echo esc_attr( Public_Hero::element( 'content', 'adam-team-container adam-team-hero__content' ) ); ?>">
			...
			<div>
				...
				<div class="<?php echo esc_attr( Public_Hero::element( 'meta', 'adam-team-hero__meta' ) ); ?>">
					...
					<?php if ( $adam_recruitment_status ) : ?><span class="adam-recruitment adam-recruitment--<?php echo esc_attr( $adam_recruitment_status ); ?>"><?php echo esc_html( $adam_recruitment ); ?></span><?php endif; ?>
				</div>
