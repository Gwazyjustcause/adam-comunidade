...
<main id="main" class="adam-experience"><div class="adam-experience-container">
	<header class="adam-section-title"><div><span><?php esc_html_e( 'ADAM Comunidade', 'adam-comunidade' ); ?></span><h1><?php esc_html_e( 'Calendário da Comunidade', 'adam-comunidade' ); ?></h1></div></header>
	<div class="adam-community-grid">
	<?php if ( ! $entries ) : ?><div class="adam-empty-state"><?php esc_html_e( 'Não existem datas futuras na comunidade.', 'adam-comunidade' ); ?></div><?php endif; ?>
